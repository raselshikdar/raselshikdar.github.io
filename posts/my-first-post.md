...
<head>
  ...
  <title>Rasel Shikdar - Personal Portfolio</title>
    ...
    <aside class="sidebar" data-sidebar>
      ...
      <div class="sidebar-info">
        ...
        <figure class="avatar-box">
          <img src="./assets/images/my-avatar-3.png" alt="Rasel Shikdar" width="80">
        </figure>

        <div class="info-content">
          <h1 class="name" title="Rasel Shikdar">Rasel Shikdar</h1>
      ...
      <div class="sidebar-info_more">
        ...
        <ul class="contacts-list">
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <a href="mailto:info@rasel.work.gd" class="contact-link">info@rasel.work.gd</a>
            </div>
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <a href="tel:+8809696051484" class="contact-link">+880 969 605 1484</a>
            </div>
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <time datetime="1998-08-15">Aug 15, 1998</time>
            </div>
        ...
        <ul class="social-list">
          ...
          <li class="social-item">
            <a href="https://fb.me/rasel597" class="social-link">
              <ion-icon name="logo-facebook"></ion-icon>
            </a>
          </li>

          <li class="social-item">
            <a href="https://x.com/rasel597" class="social-link">
              <ion-icon name="logo-twitter"></ion-icon>
            </a>
          </li>

          <li class="social-item">
            <a href="https://instagram.com/raselshikdarr" class="social-link">
              <ion-icon name="logo-instagram"></ion-icon>
            </a>
          </li>          
          
          <li class="social-item">
            <a href="https://www.itdorpon.xyz" class="social-link">
